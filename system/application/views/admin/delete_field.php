...
<html>
	<head>
		...
		<title>the Splash : Delete Field "<?=$fieldName?>"</title>
	...
	<body>
		<section id="container">
			...
			<section id="site">
				<h2>Delete Field "<?=$fieldName?>"</h2>
				<div class="prompt">
					Are you sure that you want to delete field "<?=$fieldName?>"?<br />
					<ul>
						<li><a href="<?=site_url('admin/settings/delete_field/'.$this->uri->segment(4).'/yes')?>">yes</a></li>
